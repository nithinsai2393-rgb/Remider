...
fun ReminderLocal(
    ...
    Box(
        ...
        Column(
            ...
            // 3. Task List (Middle Section - Scrollable)
                    ...
                    Row(
                        ...
                        Box(
                            modifier = Modifier
                                .size(24.dp)
                                .background(
                                    if (reminder.isDone) accentColor else Color.Transparent,
                                    RoundedCornerShape(8.dp)
                                )
                                .border(
                                    width = 2.dp,
                                    color = if (reminder.isDone) accentColor else accentColor.copy(alpha = 0.5f),
                            ...
                            if (reminder.isDone) {
                                Image(
                                    painter = painterResource(id = R.drawable.baseline_circle_24), // Placeholder for check
                                    contentDescription = null,
                        ...
                        Column {
                            ...
                            Row(verticalAlignment = Alignment.CenterVertically) {
                                Image(
                                    ...
                                    colorFilter = androidx.compose.ui.graphics.ColorFilter.tint(
                                        if (reminder.isDone) accentColor.copy(alpha = 0.3f) else accentColor.copy(alpha = 0.7f)
                                    )
                                )
                                Spacer(modifier = Modifier.width(6.dp))
                                Text(
                                    text = reminder.taskType.uppercase(),
                                    fontSize = 10.sp,
                                    fontWeight = FontWeight.Bold,
                                    color = if (reminder.isDone) accentColor.copy(alpha = 0.3f) else accentColor.copy(alpha = 0.7f),
                                    letterSpacing = 1.sp
                                )
                            }
                        }
